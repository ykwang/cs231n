...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    scores, out_cache= affine_forward(hid_out, W3, b3)
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    dhid, dW3, db3 = affine_backward(dout, out_cache)
    
    dconv, dW2, db2 = affine_relu_backward(dhid, hid_cache)
    ...
    loss += loss_data + 0.5 * self.reg * (np.sum(W1*W1)+np.sum(W2*W2)+np.sum(W3*W3))
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
